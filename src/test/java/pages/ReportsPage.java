...
public class ReportsPage {
    ...
    private static final String CREATE_REPORT = "//*[@id='sidebar']//a[contains(text(), '%s')]",
            ...
            RADIO_TEST_SUITES = "//input[@name='custom_suites_include' and @type='radio' and @value='",
    ...
    public ReportsPage selectTheFollowingTimeFrame(String selectGroupBy) {
        log.info("Selecting time frame: {}", selectGroupBy);
        $(TIME_FRAME).selectOption(selectGroupBy);
        return this;
    }
    ...
    public ReportsPage testSuites(String value) {
        log.info("Selecting test suites with value: {}", value);
        $x(TEST_SUITES).click();
        $x(RADIO_TEST_SUITES + value + "']").click();
        return this;
    }
    ...
    public ReportsPage testCases(String filterForTheTestCases, String dropdownOption, String columnChoose,
        ...
        log.info("Testing cases with filter: {}, dropdown option: {}, column: {}, cases to display: {}, access value: {}, schedule option: {}, day option: {}, hour option: {}",
    ...
    private void notifyUser () {
        log.info("Notifying user massage");
        $(NOTIFY_USER).click();
    }
